#on console type pip install git+git://github.com/avinashkd44/keras.git --upgrade  # You will get here eigenvaluedecay regularizer for tensorflow backend.
#on console type pip show keras # you can check keras version
...
# on console type train_data # you can check its loaded or not
...
K.set_image_dim_ordering('tf') # Dimension reshaping 
